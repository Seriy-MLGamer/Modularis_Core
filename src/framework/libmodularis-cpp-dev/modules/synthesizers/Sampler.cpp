...
extern "C" void MDLRS_Sampler_new_body(MDLRS::Sampler *self, const char *file);
extern "C" void MDLRS_Sampler_on_update(MDLRS::Sampler *self);
extern "C" void MDLRS_Sampler_remove_body(MDLRS::Sampler *self);

namespace MDLRS
{
	Sampler::Sampler(Modularis &project, const char *file): Module(project), input(this), volume(this, 1), envelope(this, 0, 0, 1, 0), loop(this, 0), loop_start(this, 0), loop_length(this, 0)
	{
		MDLRS_Sampler_new_body(this, file);
	}
	void Sampler::on_update()
	{
		MDLRS_Sampler_on_update(this);
	}
	Sampler::~Sampler()
	{
		MDLRS_Sampler_remove_body(this);
	}
}