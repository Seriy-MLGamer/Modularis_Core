...
#include <typedefs/modules/system/render/Modules_stages.h>

#include <typedefs/modules/system/render/Stage.h>
#include <typedefs/system/structures/linked list/Linked_list.h>

struct Modules_stages
{
	Stage *stages;
	unsigned stages_count;
};
Modules_stages Modules_stages_new(Linked_list *modules);