...
extern "C" void MDLRS_Note_chorus_new_body(MDLRS::Note_chorus *self);
extern "C" void MDLRS_Note_chorus_on_update(MDLRS::Note_chorus *self);

namespace MDLRS
{
	Note_chorus::Note_chorus(Modularis &project, float _spread, uint32_t _voices): Module(project), input(this), spread(this, _spread), voices(this, _voices), random_phases(this, 1), output(this)
	{
		MDLRS_Note_chorus_new_body(this);
	}
	void Note_chorus::on_update()
	{
		MDLRS_Note_chorus_on_update(this);
	}
}