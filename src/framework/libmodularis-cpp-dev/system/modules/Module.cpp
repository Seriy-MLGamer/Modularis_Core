...
extern "C" void MDLRS_Module_new_body(MDLRS::Module *self, MDLRS::Modularis &project);
extern "C" void MDLRS_Module_new_empty_body(MDLRS::Module *self);
extern "C" void MDLRS_Module_remove_body(MDLRS::Module *self);
