...
rem (C) 2023 Серый MLGamer. All freedoms preserved.
...
g++ -omodularis-test main.cpp -O -s -Iinclude -I"%INSTALL_DIR%\include" -L"%INSTALL_DIR%\lib" -lmodularis.dll -lmingw32 -lSDL2main -lSDL2.dll
set OLD_PATH=%PATH%
