 ...
 * class FreeVox;
 */
typedef struct FV_FreeVox FV_FreeVox;

extern void
	(*FV_FreeVox_play)(FV_FreeVox *self),
	(*FV_FreeVox_pause)(FV_FreeVox *self),
	(*FV_FreeVox_stop)(FV_FreeVox *self),
	(*FV_FreeVox_set_cursor)(FV_FreeVox *self, float cursor);
extern float (*FV_FreeVox_get_cursor)(FV_FreeVox *self);