...
#include <Modularis_Core/typedefs/user/modules/players/Sequencer/Pattern.h>
...
void
	MDLRS_Pattern_null_position(MDLRS_Pattern *self, MDLRS_Pattern_data *data),
	MDLRS_Pattern_change_position(MDLRS_Pattern *self, MDLRS_Pattern_data *data, float time),
	MDLRS_Pattern_start(MDLRS_Pattern *self, MDLRS_Note *output, MDLRS_Pattern_data *data, uint32_t scancode, float time),
	MDLRS_Pattern_play(MDLRS_Pattern *self, MDLRS_Note *output, MDLRS_Pattern_data *data, uint32_t scancode, float time);